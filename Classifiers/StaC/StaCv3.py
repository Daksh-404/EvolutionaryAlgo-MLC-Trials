...
class StackedChaining:
    def __init__(self, features, classes, split, label_order) -> None:
        ...
        self.X_Train_original, self.X_Test_original, self.Y_Train_All_original, self.Y_Test_All_original = train_test_split(features, classes, test_size = 0.3)
    ...
    def level1_chaining(self, Y_Pred_DFrame):
        ...
        Y_Test_All_L2 = self.Y_Test_All_original
